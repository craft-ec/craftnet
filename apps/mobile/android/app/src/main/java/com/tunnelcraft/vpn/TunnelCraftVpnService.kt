...
/**
 * TunnelCraft VPN Service
 *
 * Handles the VPN tunnel on Android by capturing and routing packets
 * through the TunnelCraft P2P network.
 */
class TunnelCraftVpnService : VpnService() {
    ...
    companion object {
        ...
        // Actions
        const val ACTION_CONNECT = "com.tunnelcraft.vpn.CONNECT"
        const val ACTION_DISCONNECT = "com.tunnelcraft.vpn.DISCONNECT"
    ...
    private fun initializeRustLibrary() {
        ...
        try {
            System.loadLibrary("tunnelcraft_uniffi")
