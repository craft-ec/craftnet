// CraftNetCore - Swift wrapper for UniFFI bindings
...
public typealias TCCraftNetNode = CraftNetUnifiedNode
public typealias TCError = CraftNetError

/// CraftNet namespace for initialization and utilities
public enum CraftNet {

    /// Initialize the CraftNet library
    /// Call this once at app startup before using any other API
    public static func initialize() {
        initLibrary()
        #if DEBUG
        print("[CraftNet] Library initialized via UniFFI")
        #endif
    }
